...
//
// This method is generic to the command in use and may be used by non-onexctl
// commands.
...
//
// This method is meant specifically for `onexctl diff` and may be used
// by other commands.
...
// func with that string and an onexctl exit code.
